...
export const loadUsersSuccess = createAction('[Authentication] Load Users Success', props<{ users: User[] }>());
export const loadUsersFailure = createAction('[Authentication] Load Users Failure', props<{ error: any }>());

// Load User
export const loadUser = createAction('[Authentication] Load User', props<{ id: string }>());
export const loadUserSuccess = createAction('[Authentication] Load User Success', props<{ user: User }>());
export const loadUserFailure = createAction('[Authentication] Load User Failure', props<{ error: any }>());

// Load Current User
export const loadCurrentUser = createAction('[Authentication] Load Current User');
export const loadCurrentUserSuccess = createAction('[Authentication] Load Current User Success', props<{ user: User }>());
export const loadCurrentUserFailure = createAction('[Authentication] Load Current User Failure', props<{ error: any }>());
